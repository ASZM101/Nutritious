                    ...
                    VStack {
                        ...
                        Group {
                            ...
                            VStack(alignment: .center) {
                                ...
                                HStack(spacing: 10) {
                                    ...
                                    Image(systemName: cmwl ? "checkmark.circle.fill" : "plus.circle")
                                        .fontWeight(.bold)
                        ...
                        Group {
                            ...
                            VStack(alignment: .center) {
                                ...
                                Text("All glow, no grump.")
                                    .font(.custom("AkzidenzGroteskBQ-Bold", size: 18))
                                    .padding(.top, 5)
                                
                                Text("Introducing the all-new melting soft creme and mask.")
                            ...
                            VStack(alignment: .center) {
                                ...
                                VStack(alignment: .leading) {
                                    ...
                                    HStack(alignment: .top) {
                                        ...
                                        Text("•   Strengthens skin barrier immediately*")
                                            .font(.custom("AkzidenzGroteskBQ-Reg", size: 18))
                                    ...
                                    HStack(alignment: .top) {
                                        ...
                                        Text("•   Oiliness appears reduced by 52%**")
                                            .font(.custom("AkzidenzGroteskBQ-Reg", size: 18))
                                    ...
                                    HStack(alignment: .top) {
                                        ...
                                        Text("•   Pores appear minimized by 41%**")
                                            .font(.custom("AkzidenzGroteskBQ-Reg", size: 18))
                                ...
                                HStack(alignment: .top) {
                                    ...
                                    Text("*Clinical testing on 29 women after using product for 8 weeks.")
                                        .font(.custom("AkzidenzGroteskBQ-Reg", size: 14))
                                        .padding(.vertical, 5)
